...
def main(config):
    ...
    suffix = f"min{config.min_num}_max{config.max_num}_{config.n_glimpses}_{config.shape_input}_{config.task_type}_{config.count_mode}_seed{config.seed}_weighting{config.map_neg_w}_focalGamma{config.map_focal_gamma}"
