...
ts="$(date +%Y%m%d-%H%M%S)"
logfile_ventral="${logdir}/ventral_min${min_num}_max${max_num}_glim${n_glimpses}_${ts}.log"
logfile_main="${logdir}/main_min${min_num}_max${max_num}_glim${n_glimpses}_${ts}.log"

echo "Running glimpses=${n_glimpses}, min=${min_num}, max=${max_num}"
