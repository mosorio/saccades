...
# Test sets
python3 datasets/dataset_generator.py --polar --scaling=log --luminances 0.1 0.4 0.7 --seed=0 --noise_level=0.74 --size=5000 --shapes BCDE --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --not_all_equal_class_counts
python3 datasets/dataset_generator.py --polar --scaling=log --luminances 0.3 0.6 0.9 --seed=1 --noise_level=0.74 --size=5000 --shapes BCDE --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --not_all_equal_class_counts
python3 datasets/dataset_generator.py --polar --scaling=log --luminances 0.1 0.4 0.7 --seed=2 --noise_level=0.74 --size=5000 --shapes FGHJ --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --not_all_equal_class_counts
python3 datasets/dataset_generator.py --polar --scaling=log --luminances 0.3 0.6 0.9 --seed=3 --noise_level=0.74 --size=5000 --shapes FGHJ --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --not_all_equal_class_counts

# Training set
python3 datasets/dataset_generator.py --polar --scaling=log --luminances 0.1 0.4 0.7 --seed=4 --noise_level=0.74 --size=100000 --shapes BCDE --min_num=3 --max_num=7  --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --not_all_equal_class_counts
...
python3 datasets/dataset_generator.py --policy=cheat+jitter --polar --scaling=log --luminances 0.1 0.4 0.7 --seed=5 --noise_level=0.74 --size=1000 --shapes BCDE --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --unique_class_counts
python3 datasets/dataset_generator.py --policy=cheat+jitter --polar --scaling=log --luminances 0.3 0.6 0.9 --seed=6 --noise_level=0.74 --size=1000 --shapes BCDE --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --unique_class_counts

python3 datasets/dataset_generator.py --policy=cheat+jitter --polar --scaling=log --luminances 0.1 0.4 0.7 --seed=7 --noise_level=0.74 --size=1000 --shapes FGHJ --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --unique_class_counts
python3 datasets/dataset_generator.py --policy=cheat+jitter --polar --scaling=log --luminances 0.3 0.6 0.9 --seed=8 --noise_level=0.74 --size=1000 --shapes FGHJ --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --unique_class_counts

python3 datasets/dataset_generator.py --policy=cheat+jitter --polar --scaling=log --luminances 0.1 0.4 0.7 --seed=9 --noise_level=0.74 --size=10000 --shapes BCDE --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --unique_class_counts
python3 datasets/dataset_generator.py --policy=cheat+jitter --polar --scaling=log --luminances 0.3 0.6 0.9 --seed=10 --noise_level=0.74 --size=10000 --shapes BCDE --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --unique_class_counts

python3 datasets/dataset_generator.py --policy=cheat+jitter --polar --scaling=log --luminances 0.1 0.4 0.7 --seed=11 --noise_level=0.74 --size=10000 --shapes FGHJ --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --unique_class_counts
python3 datasets/dataset_generator.py --policy=cheat+jitter --polar --scaling=log --luminances 0.3 0.6 0.9 --seed=12 --noise_level=0.74 --size=10000 --shapes FGHJ --min_num=3 --max_num=7 --solarize --n_shapes=25 --grid=6 --n_glimpses=12 --distinctive=0.3 --unique_class_counts
